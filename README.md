...
or
git clone https://github.com/IzvekovWeb/webpack_template.git webpack-template
...
Придумал и собрал [Evgenii Vedegis](https://github.com/vedees)
Аккуратно за ним повторил [Izvekov Alexander](https://github.com/IzvekovWeb)
